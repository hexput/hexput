...
**Next step:** implement Story 1.10 (check a script without running it) via `bmad-build`; its CLI surface reuses Story 1.9's, and `hexput-cli-core` already declares the `hexput-check` edge. Keep this section honest as stories land.
