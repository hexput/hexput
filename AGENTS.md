...
**Next step:** Story 2.7, keeping slow executions from blocking anything else — moving Direct Execution out of the connection's loop into independent tasks (AD-6). Keep this section honest as stories land.
