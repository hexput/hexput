...
**Next step:** Story 2.4, the init handshake — serving `Init` (and removing the temporary `protocol.not_implemented`), issuing a Client ID and creating a Session with its Config and registrations, built together with 2.5's Session/Connection model. Keep this section honest as stories land.
