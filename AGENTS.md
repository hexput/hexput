...
**Next step:** Story 2.6, Direct Execution — serving `ExecutionStart` on an initialized connection through the one `Executor` (and removing the temporary `protocol.not_implemented`). Keep this section honest as stories land.
