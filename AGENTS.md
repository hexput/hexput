...
**Next step:** Story 2.3, accepting connections over a Unix Domain Socket (the async `Port` trait and its first adapter, wrapping `hexput-port`'s codec). Keep this section honest as stories land.
