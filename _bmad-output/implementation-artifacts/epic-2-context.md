...
- **Pinned stack:** tokio 1.53.1, serde 1.0.229, rmp-serde 1.3.1, tracing 0.1.44, clap 4.6.7, toml 1.1.6, tracing-subscriber 0.3.23 (Story 2.1), rmpv 1.3.1 with `with-serde` (Story 2.2) — pinned, with their feature sets, once in `[workspace.dependencies]`, inherited per crate.
